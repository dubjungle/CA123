...
public class CA123 {
    ...
    public static void main(String args[]){
        try { //  FileReader reading text from the students.txt file
            ...
            // This means it currently doesn't point to any specific string or object
            ...
            for (int i = 1; sc.hasNextLine(); i++) {
               ...
               // this loop iterates three times (j starts from 0 and goes up to 2 )
                ...
                // check or j it's equals to 2.
                    ...
                    //Extracting the first and last name from the splitNames array.
                   ...
                   studentNumber = eachLine[2];
                    ...
                    // Print the full name
                    //Print the number of classes stored in numberOfClasses variable
                    // Print the student number stored in studentNUmber variable
                     ...
                     // the regular expression [a-zA-Z]+ ensures that the string consists of on or more letters
                ...
                System.out.println ("No symbols please ");
                 // The regular expression "^[A-Za-z]+ [A-Za-z0-9]+$" expects to lastName to:
